...
Env:
  ...
  GH_LOGIN      user to summarise (required outside GitHub Actions; otherwise
                GITHUB_REPOSITORY_OWNER is used)
...
def main():
    ...
    if not login:
        sys.exit("GH_LOGIN or GITHUB_REPOSITORY_OWNER is not set")
